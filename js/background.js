...
else if (info.menuItemId == "totlshareemail") {window.open("mailto:youremail?subject=Turn Off the Lights Opera extension&body=Hé, This is amazing. I just tried today this Turn Off the Lights Opera extension https://addons.opera.com/en/extensions/details/turn-off-the-lights", "_blank");}
else if (info.menuItemId == "totlsharetwitter") {window.open("http://twitter.com/home?status=Try%20self%20this%20amazing%20Turn%20Off%20the%20Lights%20Opera%20extension%20addons.opera.com/en/extensions/details/turn-off-the-lights", "_blank");}
else if (info.menuItemId == "totlsharefacebook") {window.open("https://www.facebook.com/sharer/sharer.php?u=addons.opera.com/en/extensions/details/turn-off-the-lights", "_blank");}
...
try{ chrome.runtime.setUninstallUrl("https://www.turnoffthelights.com/extension/firefoxuninstalled.html"); }
catch(e){}
...
if ((chromeset["firstRun"]!="false") && (chromeset["firstRun"]!=false)){
  ...
  chrome.tabs.create({url: "https://www.turnoffthelights.com/extension/firefoxwelcome.html", selected:true})
  chrome.tabs.create({url: "https://www.turnoffthelights.com/extension/firefoxguide.html", selected:false})
